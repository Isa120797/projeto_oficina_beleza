...
-- Copiando dados para a tabela db_oficina_beleza.tb_agendamento: ~3 rows (aproximadamente)
INSERT INTO `tb_agendamento` (`id`, `id_cliente`, `id_funcionario`, `id_servico`, `data`, `hora`, `valor`, `status`) VALUES
	...
	(3, 1, 3, 3, '2026-06-03', '14:00:00', 50.00, 'Cancelar'),
...
-- Copiando dados para a tabela db_oficina_beleza.tb_cliente: ~2 rows (aproximadamente)
...
INSERT INTO `tb_funcionario` (`id`, `nome`, `email`, `telefone`, `senha`, `token`, `data_cadastro`, `status`) VALUES
	...
	(7, 'Maria Luiza Santos Oliveira', 'juju@gmail.com', '19987964587', '', NULL, '2026-05-20 15:40:32', 'ativo');
