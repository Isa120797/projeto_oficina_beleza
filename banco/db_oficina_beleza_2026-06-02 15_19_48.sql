...
-- Copiando dados para a tabela db_oficina_beleza.tb_funcionario: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela db_oficina_beleza.tb_login: ~0 rows (aproximadamente)
