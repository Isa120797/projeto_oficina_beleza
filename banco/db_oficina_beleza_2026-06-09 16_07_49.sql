...
-- Copiando dados para a tabela db_oficina_beleza.tb_agendamento: ~6 rows (aproximadamente)
...
INSERT INTO `tb_cliente` (`id`, `nome`, `data_nascimento`, `endereco`, `email`, `telefone`, `cidade`, `estado`, `data_cadastro`, `ativo`) VALUES
	(1, 'Vagner Costa Souza', '1986-01-19', 'Rua: João da Silva', 'vagnersouza@gmail.com', '(19) 99656-2544', 'São João da Boa Vista', 'Santa Catarina', '2026-05-20 00:00:00', 0),
	(2, 'Júlio Cesar Rodrigues', '2011-03-12', 'Rua: João da Silva Souza', 'juliocesar@gmail.com', '19987964587', 'São João da Boa Vista', 'São Paulo', '2026-05-20 00:00:00', 1),
...
-- Copiando dados para a tabela db_oficina_beleza.tb_meta: ~0 rows (aproximadamente)
...
INSERT INTO `tb_produto` (`id`, `nome`, `marca`, `categoria`, `preco_custo`, `preco_venda`, `estoque_atual`, `estoque_minimo`, `data_cadastro`, `ativo`) VALUES
	(1, 'Shampoo', 'Yellow', 'Cabelo', 35.00, 45.00, 10.00, 5.00, '2026-05-15 13:53:43', 1),
	(2, 'Condicionador', 'Lowel', 'Cabelo', 45.00, 65.00, 12.00, 3.00, '2026-05-20 13:51:28', 1),
	(8, 'Chapa', 'Lizz', 'Cabelo', 300.00, 500.00, 2.00, 1.00, '2026-05-20 15:39:04', 1);
